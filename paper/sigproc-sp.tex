...
\title{TERRAN: An marginal density based hierarchical clustering algorithm for high dimensional continuous datasets
...
\category{H.4}{Clustering}{Mixture Models}
...
s_o &= \sqrt{-2\log R}
\end{align*}
Note that $z$ here is a complex number, whose phase and magnitude are used to subsequently compute the optimal mean and standard deviations.
